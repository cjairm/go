...
func BenchmarkBubbleSort(b *testing.B) {
	for i := 0; i < b.N; i++ {
		BubbleSort([]int{1, 10, 19, 20, 2, 3, 10, 18, 10})
	}
}

func ExampleBubbleSort() {
	fmt.Println(BubbleSort([]int{1, 10, 19, 20, 2, 3, 10, 18, 10}))
	// Output:

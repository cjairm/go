...
func BenchmarkInsertionSort(b *testing.B) {
	for i := 0; i < b.N; i++ {
		InsertionSort([]int{1, 10, 19, 20, 2, 3, 10, 18, 10})
	}
}

func ExampleInsertionSort() {
	fmt.Println(InsertionSort([]int{1, 10, 19, 20, 2, 3, 10, 18, 10}))
	// Output:
